...
export default function ShareButtons({ title, summary, className = '' }: ShareButtonsProps) {
  ...
  if (!currentUrl) {
    return (
      <div className={`text-center ${className}`}>
        <div className="inline-block animate-pulse bg-gray-200 h-10 w-64 rounded-lg"></div>
      </div>
    );
  }
